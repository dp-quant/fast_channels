...
class EchoServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Echo = channel.unary_unary(
                '/app.schemas.echo.EchoService/Echo',
...
def add_EchoServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'app.schemas.echo.EchoService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('app.schemas.echo.EchoService', rpc_method_handlers)
